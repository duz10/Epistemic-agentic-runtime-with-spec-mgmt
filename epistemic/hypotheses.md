...
### H5: Coalition Contracts Work (Stage C)
...
- **Status**: 🟡 Untested
- **Test Plan**: Form a coalition of 2+ agents with shared scope, test exit conditions
...
| H5 | Coalition contracts | C | 🟡 Untested | 0.55 |
| H6 | Distance vector self-selection | D | 🟡 Untested | 0.50 |

---

*Last updated: 2025-01-10 after H4 compliance enforcement validation*
