# ELCS Project Assumptions

*Tracking what we assume to be true about the ELCS Framework project*

## Active Assumptions

| ID | Assumption | Confidence | Status |
|----|------------|------------|--------|
| A1 | AI agents will respect bootstrap files (CLAUDE.md, .cursorrules) | 0.85 | Active |
| A2 | File-based artifacts are more durable than agent memory | 0.95 | Active |
